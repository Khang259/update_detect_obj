...
BOUNDING_BOXES = [
    ...
    {  # Camera 4: 192.168.1.30
        "starts": [
            [909, 233, 1011, 293],  # Task path 10000557
            [716, 218, 826, 317],  # Task path 10000558
            [535, 182, 672, 310],  # Task path 10000559
            [360, 210, 486, 319],   # Task path 10000560 
        ],
        "ends": [
            [213, 230, 284, 326]  # Task path 10000565
        ]
    },
    {  # Camera 5: 192.168.1.31
        "starts": [
            [284, 382, 317, 481],  # Task path 10000452
            [375, 385, 425, 483],  # Task path 10000455
            [472, 388, 534, 484],   # Task path 10000458
            [565, 393, 632, 488],  # Task path 10000461
        ],
        "ends": [
            [346, 238, 399, 322]  # Task path 10000556
        ]
    },
    # {
    #     "starts": [
...
BBOX_TO_TASKPATH = {
    ...
    "509_85_623_202": "10000125",
    "509_256_623_364": "10000126",
    "909_233_1011_293": "10000557",
    "716_218_826_317": "10000558", 
    "535_182_672_310": "10000559",
    "360_210_486_319": "10000560",
    "213_230_284_326": "10000565",
    "284_382_317_481": "10000452",
    "375_385_425_483": "10000455",
    "472_388_534_484": "10000458",
    "565_393_632_488": "10000461",
    "665_458_746_555": "10000464",
    "346_238_399_322": "10000556"
}

START_TASK_PATHS = ["10000172","10000173", "10000174", "10000175", "10000176", "10000177", "10000178", "10000179", "10000146", "10000234", "10000123", "10000124","10000557", "10000558", "10000559", "10000560", "10000452", "10000455", "10000458", "10000461"]
END_TASK_PATHS = ["10000164", "10000170", "10000171", "10000140", "10000141", "10000147", "10000125", "10000126", "10000565", "10000556"]
...
AVAILABLE_PAIRS = [
    ...
    {
        "starts": ["10000452", "10000455", "10000458", "10000461"],
