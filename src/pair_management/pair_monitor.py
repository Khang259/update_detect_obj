...
#                 #     logger.debug(f"Sent pairs queue after get: {self.sent_pairs_queue}")
...
#                     elif end_state and mark_post_sent == True:
#                         self.used_starts.discard(start_idx)
#                         self.used_ends.discard(end_idx) 
#                         logger.debug(f"Removed ({start_idx}, {end_idx}) from used_starts and used_ends due to end_state={end_state} and mark_post_sent={mark_post_sent}")
